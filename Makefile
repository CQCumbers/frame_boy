...
main.html: memory.cpp cpu.cpp ppu.cpp apu.cpp timer.cpp joypad.cpp gameboy.cpp main.cpp
	emcc --profiling -Wall -Werror -Wextra -flto -g --std=c++11 memory.cpp cpu.cpp ppu.cpp apu.cpp timer.cpp joypad.cpp gameboy.cpp main.cpp -o dist/main.html -O3 --preload-file roms -s WASM=1 -s USE_SDL=2 --emrun
